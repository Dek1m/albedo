...
| Поле | Значение |
|------|----------|
| **Статус** | accepted — вердикты Мастера от 02.09.2026 (schema review Норы внесено в ревизию 3; security review Литы — фронт-требования внесены в ревизию 4; передана Соне) |
| **Дата** | 2026-09-02 (accepted 02.09.2026; ревизия 4 — security review Литы, фронт-требования) |
