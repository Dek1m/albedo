...
| Поле | Значение |
|------|----------|
| **Статус** | accepted (решения утверждены Мастером 02.09.2026; schema review Норы внесено в ревизию 3; финальное ревью Литы — до шага 5 плана) |
| **Дата** | 2026-09-02 (ревизия 3 — schema review Норы) |
...
- **Каждый fs-RPC = ровно одна дисковая операция + одна ACL-проверка.** Никакой композиции «диск + БД workspace» в fs — для этого есть фасад workspace.
...
Порядок строгий, шаг за шагом; UI albedo не трогаем до конца шага 5. Финальное ревью Литы — до шага 5 (статус accepted, ревизия 3).
...
- Статус документа: **accepted**; финальное ревью Литы — до шага 5 плана (§17).
